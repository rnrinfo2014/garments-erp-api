...
def update_supplier_ledger(payment: SupplierPayment, db: Session):
    ...
    try:
        ...
        new_balance = current_balance - payment.gross_amount  # Payment reduces supplier balance
...
async def update_supplier_payment(
    ...
    # Update payment fields using update query
...
async def post_supplier_payment(
    ...
    try:
        # Update payment status using update query
